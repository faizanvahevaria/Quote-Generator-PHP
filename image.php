...
$caption = $text . "\n\n#" . str_replace(' ', '', $AUTHOR) . " #" . $GENRE. " #" . $GENRE . "Quotes #KingsmanMotivation #Motivation #MotivationQuote #MotivationQuotes #DailyMotivation #Inspiration #InspirationQuotes #IGDaily #instadaily #LifeMotivation" ;
